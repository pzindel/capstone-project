/**
 * @file Driver_I2C.h
 * @brief I<sup>2</sup>C header file for RSLxx family of devices
 */
/*
 ...
 */
/**
 * @defgroup CMSISDRVI2Cg CMSIS I2C Driver
 * @brief CMSIS I<sup>2</sup>C Driver Reference
 * @{
 */
...
#define ARM_I2C_API_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(2,3)  ///< I2C API version
